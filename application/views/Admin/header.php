   ...
   <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= site_url('Admin/dashboard'); ?>">Advance Industry Maintainance</a>
            </div>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="javascript:void(0);" class="bars"></a>
                <a class="navbar-brand" href="<?= site_url('Admin/dashboard'); ?>">Advance Industery Management</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div>
                <ul class="list" >
                    ...
                    <li>
                        <a href="<?= site_url('Admin/level'); ?>" class="">
                    ...
                    <li>
                        <a href="<?= site_url('Admin/access_level') ?>" class="">
                            <i class="material-icons">notifications</i>
                    ...
                    <li>
                        <a href="<?= site_url('Admin/media'); ?>" class="">
                    ...
                    <li>
                        <a href="<?= site_url('Admin/shared_with') ?>" class="">
                       ...
                       <li>
                        <a href="<?= site_url('Admin/employee_log') ?>" class="">
                            <i class="material-icons">people</i>
               ...
               $("#searching-panel").fadeIn('fast');
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                               //$("#search-result").load('<?= site_url("Admin/search"); ?>').fadeIn();
                               $("#search-rows").fadeIn();
