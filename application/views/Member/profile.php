    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
             ...
             <div class="col-lg-4 " id="detail_notify" style="cursor: pointer;float: right;margin-top: -50px;position: fixed;display: none;">
             ...
             <div class="col-lg-4 " id="profile_notify" style="cursor: pointer;float: right;margin-top: -50px;position: relative;background: #fff;margin-bottom: 20px;display: none;">
...
$(document).ready(function (e) {
    $("#uploadForm").on('submit',(function(e) {
        ...
        if ($("#fileInput").val()=='') {
            ...
            $.ajax({
            url: "<?= site_url('Member_login/change_profile_pic') ?>", 
            type: "POST",
  ...
  function frame() {
    if (width >= 100) {
        $(".msg").html('All Done, Looking Good');
                    $("#data").load("<?= site_url('Member_login/ajax_profile_pic') ?>");
                     $("#data").load("<?= site_url('Member_login/ajax_profile_pic') ?>");
                           ...
                           <?php
                            ...
                            foreach($data as $d):
                            {
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="fname" class="form-control" value="<?= $d->fname?>" name="fname" required>
                                 ...
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="lname" class="form-control" value="<?= $d->lname; ?>" name="lname" required>
                            ...
                            -->
                                ...
                                <?php
                                 ...
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="password" class="form-control" value="<?= $d->pass ?>" name="pass" required>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#submit<?= $d->id ?>").click(function(){
            ...
            $.ajax({
                    url:'<?= site_url("Member_login/update_profile") ?>',
                    type:'post',
